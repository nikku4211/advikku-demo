...
CFILES		:=	$(foreach dir,$(SOURCES),$(notdir $(wildcard $(dir)/*.c))) $(foreach dir,$(MUSIC),$(notdir $(wildcard $(dir)/*.c)))
...
#---------------------------------------------------------------------------------
	...
	$(ptexconv) -gb -b 4 -p 3 -pb 1 -pc $< -oc -o $(basename $@)

#---------------------------------------------------------------------------------
bg1.c bg1.h: bg1.png
#---------------------------------------------------------------------------------
	@echo "$(ptexconv) $(notdir $<)"
	$(ptexconv) -gb -b 4 -p 1 -pc $< -oc -o $(basename $@)
